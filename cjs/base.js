...
(function() {
  ...
  if (cookiesBannerDiv) {
    ...
    document.getElementById("cookiesAcceptAllBtn").addEventListener('click', function() {
      setCookie("cookie_pref", "111", 120);
      closeCookieBanner();
    });
    // Cookie custom options
    document.getElementById("cookiesCustomAllBtn").addEventListener('click', function() {
      setCookie("cookie_pref", "111", 120);
      closeCookieBanner();
    });
    document.getElementById("cookiesCustomOptBtn").addEventListener('click', function() {
